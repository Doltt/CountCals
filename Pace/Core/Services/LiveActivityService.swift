...
final class LiveActivityService {
    ...
    private var currentActivity: Activity<PaceWidgetsAttributes>?
    ...
    func start(
        ...
        Task {
            ...
            let attributes = PaceWidgetsAttributes(dailyTarget: dailyTarget)
    ...
    func update(
        ...
        let newState = PaceWidgetsAttributes.ContentState(
            remainingCalories: remainingCalories,
            remainingCarbs: remainingCarbs,
            remainingProtein: remainingProtein,
            remainingFat: remainingFat
    ...
    func endAll() async {
        for activity in Activity<PaceWidgetsAttributes>.activities {
            await activity.end(nil, dismissalPolicy: .immediate)
        }
        currentActivity = nil
    }
    ...
    var isActive: Bool {
        currentActivity != nil || !Activity<PaceWidgetsAttributes>.activities.isEmpty
    }
}
